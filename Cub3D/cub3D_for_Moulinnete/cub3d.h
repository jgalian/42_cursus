...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/09/23 09:34:43 by jgalian-          #+#    #+#             */
/*   Updated: 2020/09/23 13:04:09 by jgalian-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
float				dist_between_points(float x1, float y1, float x2,
					float y2);
...
void				draw_walls(t_all *a, int i, float w_top_pix,
					float w_bot_pix);
void				draw_ceiling_and_floor(t_all *a, int i, float w_top_pix,
					float w_bot_pix);
unsigned int		get_color_from_texture(t_all *a, int i,
...
# define WALL_1_PATH			"./textures/wall_1.xpm"
# define WALL_2_PATH			"./textures/wall_2.xpm"
# define WALL_3_PATH			"./textures/wall_3.xpm"
# define WALL_4_PATH			"./textures/wall_4.xpm"
# define SPR_1_PATH				"./textures/sprite_1.xpm"
